...
FULL_DISTANCE_MATRIX = [
    [0, 4.55, 6.34, 6.01, 6.96, 7.92, 8.84, 9.11, 7.49, 8.18, 6.34, 4.79, 3.99, 5.25, 7.29, 7.99, 7.99, 7.89, 5.71, 2.48, 2.14],
    ...
    [7.92, 6.5, 5.84, 3.73, 2.61, 0, 2.38, 1.78, 0.99, 1.91, 1.95, 4.22, 4.75, 3.04, 2.94, 3.0, 4.62, 3.96, 4.03, 5.54, 6.04],
    [8.84, 8.58, 7.62, 5.05, 3.5, 2.38, 0, 1.09, 1.58, 1.12, 3.1, 5.31, 6.27, 5.01, 2.57, 2.87, 3.23, 3.89, 5.15, 6.8, 6.93],
    [9.11, 7.95, 7.03, 7.26, 3.6, 1.78, 1.09, 0, 1.19, 1.25, 2.87, 5.41, 5.87, 3.3, 1.55, 1.95, 2.34, 3.1, 5.21, 7.39, 7.29],
    [7.49, 6.7, 6.27, 3.8, 3.66, 0.99, 1.58, 1.19, 0, 3.07, 1.78, 4.72, 5.12, 2.21, 4.55, 4.16, 4.52, 5.15, 4.06, 5.25, 5.68],
    [8.18, 7.79, 7.36, 5.02, 3.53, 1.91, 1.12, 1.25, 3.07, 0, 3.3, 5.58, 6.27, 3.89, 0.99, 1.58, 2.47, 2.44, 4.19, 7.0, 6.73],
    [6.34, 5.21, 4.88, 2.21, 1.35, 1.95, 3.1, 2.87, 1.78, 3.3, 0, 2.61, 3.07, 0.96, 3.27, 3.86, 3.96, 3.8, 2.8, 4.12, 3.83],
    [4.79, 2.54, 2.11, 1.22, 2.74, 4.22, 5.31, 5.41, 4.72, 5.58, 2.61, 0, 0.99, 3.2, 5.77, 6.86, 7.62, 5.91, 4.32, 3.0, 3.23],
    [3.99, 3.3, 2.87, 1.98, 3.23, 4.75, 6.27, 5.87, 5.12, 6.27, 3.07, 0.99, 0, 2.84, 5.25, 5.77, 6.04, 6.04, 3.0, 1.98, 2.21],
    [5.25, 4.19, 5.87, 3.3, 2.11, 3.04, 5.01, 3.3, 2.21, 3.89, 0.96, 3.2, 2.84, 0, 3.3, 3.9, 3.89, 3.5, 1.98, 3.24, 3.27],
    [7.29, 6.66, 8.18, 5.18, 4.16, 2.94, 2.57, 1.55, 4.55, 0.99, 3.27, 5.77, 5.25, 3.3, 0, 1.22, 1.19, 1.78, 2.9, 5.81, 5.68],
    [7.99, 6.9, 8.94, 5.68, 4.69, 3.0, 2.87, 1.95, 4.16, 1.58, 3.86, 6.86, 5.77, 3.9, 1.22, 0, 0.59, 1.39, 3.43, 5.74, 6.1],
    [7.99, 7.23, 8.78, 6.6, 5.15, 4.62, 3.23, 2.34, 4.52, 2.47, 3.96, 7.62, 6.04, 3.89, 1.19, 0.59, 0, 1.19, 5.28, 7.79, 5.87],
    [7.89, 6.2, 8.45, 7.46, 4.88, 3.96, 3.89, 3.1, 5.15, 2.44, 3.8, 5.91, 6.04, 3.5, 1.78, 1.39, 1.19, 0, 3.27, 5.87, 5.87],
    [5.71, 4.09, 5.64, 6.01, 3.89, 4.03, 5.15, 5.21, 4.06, 4.19, 2.8, 4.32, 3.0, 1.98, 2.9, 3.43, 5.28, 3.27, 0, 2.77, 3.1],
    [2.48, 2.57, 5.58, 3.83, 4.55, 5.54, 6.8, 7.39, 5.25, 7.0, 4.12, 3.0, 1.98, 3.24, 5.81, 5.74, 7.79, 5.87, 2.77, 0, 0.59],
    [2.14, 2.51, 4.98, 4.26, 5.44, 6.04, 6.93, 7.29, 5.68, 6.73, 3.83, 3.23, 2.21, 3.27, 5.68, 6.1, 5.87, 5.87, 3.1, 0.59, 0]
]
...
def task_generation(num_nodes_to_pick):
    ...
    with open(PAR_FILE_PATH, 'w') as file:
        file.write("PROBLEM_FILE = /home/ubuntu/git/T11_multi_warehouse/main_ws/src/idk/LKH-3.0.9/TSP_TEST.txt\n")
        file.write("OUTPUT_TOUR_FILE = /home/ubuntu/git/T11_multi_warehouse/main_ws/src/idk/LKH-3.0.9/TSP_TEST_OUTPUT_TOUR\n")
        file.write("TOUR_FILE = /home/ubuntu/git/T11_multi_warehouse/main_ws/src/idk/LKH-3.0.9/TSP_TEST_TOUR\n")
